        ...
        const loadSettings = async () => {
            try {
                ...
                if (storedSettings) {
                    ...
                    const legacySettings = storedSettings as any;
                    if (legacySettings.useFilesApiForImages !== undefined && !storedSettings.filesApiConfig) {
                        newSettings.filesApiConfig = {
                            ...DEFAULT_FILES_API_CONFIG,
                            images: legacySettings.useFilesApiForImages
                        };
                        // Cleanup deprecated key
                        delete legacySettings.useFilesApiForImages;
