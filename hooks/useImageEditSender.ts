...
import { generateUniqueId, buildContentParts, base64ToBlob, createChatHistoryForApi, logService, getActiveProxyUrl } from '../utils/appUtils';
...
export const useImageEditSender = ({
    ...
    const handleImageEditMessage = useCallback(async (
        ...
        try {
            ...
            const callApi = () => geminiServiceInstance.editImage(keyToUse, currentChatSettings.modelId, historyForApi, promptParts, newAbortController.signal, aspectRatio, proxyUrl);
