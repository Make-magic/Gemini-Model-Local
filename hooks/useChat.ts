...
export const useChat = (appSettings: AppSettings, setAppSettings: React.Dispatch<React.SetStateAction<AppSettings>>, language: 'en' | 'zh') => {
    ...
    // DEPRECATED: useChatClient removed in favor of stateless fetch-based architecture in useMessageSender.
    ...
    const messageHandler = useMessageHandler({ 
        ...
        scrollContainerRef: scrollHandler.scrollContainerRef, chat: null 
    });
