...
import { getKeyForRequest, logService, getActiveProxyUrl } from '../utils/appUtils';
...
export const useSuggestions = ({
    ...
    const generateAndAttachSuggestions = useCallback(async (sessionId: string, messageId: string, userContent: string, modelContent: string, sessionSettings: IndividualChatSettings) => {
        ...
        try {
            const suggestions = await geminiServiceInstance.generateSuggestions(keyResult.key, userContent, modelContent, language, proxyUrl);
